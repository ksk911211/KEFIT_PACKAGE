...
class guifittool:
    ...
    def fitting_func_option(self):
        ...
        for k in range(4):
            ...
            self.note_fn['m%i'%(k+1)].config(width=9)
    ...
    def make_mds(self):
        ...
        self.note_md['e1'] = tk.Entry(self.home['page7'],width=14,justify='center')
        ...
        b3 = tk.Button(self.home['page7'],text="LOAD TCI", height = 1, width = 19,command=lambda: self.make_mds_c())    
        b3.grid(row=6, column=4,columnspan=5,pady=5)
        self.l1 = tk.Label(self.home['page7'], text='dt[ms]/drift',justify='center')
        ...
        self.note_md['e12'] = tk.Entry(self.home['page7'],width=5,justify='center')             
        self.note_md['e12'].grid(row=6,column=3)           
        self.note_md['e12'].insert(10,self.note_md['tcidrift'].get())
        ...
        b4 = tk.Button(self.home['page7'],text="LOAD ECE", height = 1, width = 15,command=lambda: self.make_mds_d())    
        b4.grid(row=8, column=5,columnspan=4,pady=5)
        ...
        self.note_md['c2'].grid(row=8, column=4)
    ...
    def make_mds_c(self):
        ...
        drift = 0;
        try: 
            drift= float(self.note_md['e12'].get())
            print('>>> Drift rate is given',drift);
        except: pass

        cdir = os.getcwd()
        os.chdir(self.mds_dir)
        command = '%s %s %i %i %i %f %s'%(pythonc_exec, mds_tci, shot, time, dt, drift, 'tci_result.dat')
        os.system(command)
        os.chdir(cdir)
...
#       frame.resizable(0,0)
    ...
    def check_runmode(self):
        ...
        #Load previous param for initial plot
        for flag in self.fit.prof_list:
            func = self.note_fn['func_type'][flag].get().lower()
...
#       self.restore_gui()
    ...
    def make_etc(self):
        ...
        self.note_ec['c%i'%countc] = tk.Checkbutton(self.home['page9'],variable=self.note_ec['save_sample'])
        self.note_ec['c%i'%countc].grid(row=count1+2,column=2*3+1,columnspan=2)
    ...
    def initialise_variables(self):
        ...
        self.note_ec['save_sample']   = tk.IntVar()
        ...
        self.note_md['tcidrift'] = tk.StringVar()
    ...
    def put_fit_opt(self):
        ...
        self.fit.fit_opt['tcidrift']          = self.transfer_float(self.note_md['tcidrift'],True)
    ...
    def get_fit_opt(self):
        ...
        self.note_md['tcidrift'].set(self.transfer_float(self.fit.fit_opt['tcidrift'],False))
    ...
    def sync_gui_opt(self,g2v=True,skip_mds=False):
        ...
        if g2v:
            ...
            self.note_md['tcidrift'].set(self.note_md['e12'].get())
        else:
            ...
            self.put_vars_to_gui(['note_md','e12'],self.note_md['tcidrift'].get())
    ...
    def run_save(self):
        ...
        if self.note_ec['save_sample'].get()  == 1:
    ...
    def load_fitopt_dict(self,fit_opt,input_skip=False):
        ...
        try:
            self.fit.fit_opt['tcidrift']= fit_opt['tcidrift']
        except: pass
    ...
    def read_multi_fitopt(self):
        ...
        try:
            self.fit.fit_opt['tcidrift']= force_opt['tcidrift']
        except: pass
