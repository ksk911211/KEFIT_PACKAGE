...
#       nodelist1 = nodelist1 + ',' + nodelist_t[i+1].split()[0]
    ...
    for i in range(nw):
        for j in range(nh):
            ...
            command = 'export LD_LIBRARY_PATH=/UKSTAR_HOME/ksk911211/CODE/lib32:$LD_LIBRARY_PATH \n'
            
            command = command + 'cd ' + currdir + ' \n'
    ...
    command = 'export LD_LIBRARY_PATH=/usr/lib:$LD_LIBRARY_PATH \n'
